    ...
    return (
      <section className="mb-8 rounded-2xl border border-purple-500/30 bg-[var(--surface)] p-5">
        ...
        <div className="mb-3 rounded-xl border border-[var(--stroke)] bg-[#0b1528] p-3 text-xs text-slate-400 space-y-1.5">
          ...
          <p className="text-amber-400/80 text-[11px]">Sports VS: format "[Team A] vs [Team B]: Who will win [event/date]?" (neutral phrasing — never "Will [Team] win") · logo_url = Team A, logo_url_b = Team B · add "team_a"/"team_b" (e.g. "MI"/"RCB") to label the YES/NO buttons. Individual sports: free-form question text · logo_url = team/player, logo_url_b = null.</p>
        </div>
