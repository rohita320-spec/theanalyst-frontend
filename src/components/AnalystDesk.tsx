...
const CATEGORY_DEFAULT_SYMBOL: Record<string, string> = {
  ...
  Economy: "NSE:NIFTY50",
  Markets: "NSE:NIFTY50",
  "Global events": "TVC:DXY",
  Entertainment: "NASDAQ:NFLX",
  Sports: "NYSE:DKNG",
  General: "NSE:NIFTY50",
};
...
export default function AnalystDesk({ category, mode = "create" }: Props) {
  ...
  // When category changes while desk is open, reset symbol
  useEffect(() => {
  ...
  const links = RESEARCH_LINKS[category] || RESEARCH_LINKS["General"];
          ...
          {activeTab === "chart" && (
            <div>
              ...
              <p className="mb-2 text-[10px] text-slate-500">
                Use format <span className="text-slate-300">EXCHANGE:SYMBOL</span> — e.g. NSE:RELIANCE · BINANCE:ETHUSDT · NASDAQ:TSLA. You can also change the symbol inside the chart.
              </p>
